...
int main() {
    ...
    do {
        printf("\nMENU\n");
        printf("1. Nhap so luong và thong tin sach.\n");
        printf("2. Hien thi thong tin sach.\n");
        printf("3. Them sach vào vi tri.\n");
        ...
        switch (choice) {
            ...
            case 2:
                printf("\nThông tin cac cuon sach:\n");
                printf("%-10s %-30s %-20s %-10s %-20s\n", "Ma sách", "Ten sach", "Tac gia", "Gia tien", "The loai");
                for (i = 0; i < n; i++) {
